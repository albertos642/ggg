/**
 * @file RamStorage.h
 * @brief Forwarding header for RamStorage implementation.
 *
...
#ifndef GGG_RAM_STORAGE_CONVENIENCE_H
#define GGG_RAM_STORAGE_CONVENIENCE_H

#include "include/ggg/hal/RamStorage.h"

#endif // GGG_RAM_STORAGE_CONVENIENCE_H
