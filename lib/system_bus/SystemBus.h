/**
 * @file SystemBus.h
 * @brief Forwarding header for SystemBus implementation.
 *
...
#ifndef GGG_LIB_SYSTEM_BUS_CONVENIENCE_H
#define GGG_LIB_SYSTEM_BUS_CONVENIENCE_H

#include "include/ggg/system/SystemBus.h"

#endif // GGG_LIB_SYSTEM_BUS_CONVENIENCE_H
